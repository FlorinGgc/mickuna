<div class="modal fade" id="modal-delete-{{str_replace('.', '', $diagnostico->id)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      ¿Deseas eliminar el registro {{$diagnostico->id." ".$diagnostico->repuesto}}?
      </div>
