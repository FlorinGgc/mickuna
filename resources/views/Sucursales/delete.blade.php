<div class="modal fade" id="modal-delete-{{str_replace('.', '', $Sucursale->id)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¿Deseas eliminar el registro {{$Sucursale->id." ".$Sucursale->regionsurcusale}}?
      </div>
